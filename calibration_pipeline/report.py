...
def parse_args(argv=None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--table1", help="Default: ABLATION_TEST_result/<session>/ABLATION_TEST_table1/ABLATION_TEST_table1_methods.json")
    parser.add_argument(
        "--out_dir", help="Default: ABLATION_TEST_result/<session>/ABLATION_TEST_table1")
    parser.add_argument(
