...
`CP_result/D1_session02_fkmodes/` (`CP_D1_fk_correction_2x2.py`, 같은 backend·같은 solver
...
PYTHONPATH= python CP_D1_fk_correction_2x2.py \
    ...
    --out_dir CP_result/D1_session02_fkmodes --lambdas 0 --folds all

# 두 방식의 전체 데이터 fit (약 1.5분)
PYTHONPATH= python CP_final_fk_mode_fit.py \
    --root_folder data/session02/calib_train --intrinsics_dir intrinsics \
    --calib_dir data/session02/calib_out --out_dir CP_result/final_fk_mode_fit
