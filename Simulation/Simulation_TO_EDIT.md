...
- visual problem/state/solver: `calibration_reprojection_backend.py`
- FK factor: `calibration_fk_factor.py`
- 조건과 freeze mask: `CP_table1_schema.py`
- px 평가 정의: `table1_evaluation.py`
...
- 생성 관측을 `calibration_reprojection_backend.PixelObs`로 변환한다.
