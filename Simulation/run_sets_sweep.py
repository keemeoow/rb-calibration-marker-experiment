...
CB = ("cube", "board")
METHODS = [
    ExpConfig("EXP1", fk="corr",  solve="unified",     markers=CB, anchor_weight=0.5, label="Ours"),
    ...
    ExpConfig("EXP2", fk="corr",  solve="independent", markers=CB, anchor_weight=0.5, label="-unified(indep)"),
]
SETS = [4, 6, 8, 10, 13, 16]
